...
$(function(){
    ...
    $.getJSON("../data/empresa.json",function(dat){
         var dat1 = dat["label_1"];
         var nom1 = dat["data_1"];

        var dat2 = dat["label_2"];
        var nom2 = dat["data_2"];

        var dat3 = dat["label_3"];
        var nom3 = dat["data_3"] ;

        var dat4 = dat["label_4"];
         var nom4 = dat["data_4"] ;

         var dat5 = dat["label_5"];
         var nom5 = dat["data_5"] ;

         var dat6 = dat["label_6"];
         var nom6 = dat["data_6"];

         var dat7 = dat["label_7"];
         var nom7 = dat["data_7"];
...
$(function() {
      ...
      $.getJSON("../data/bancomer_2017-03-11_resultados.json", function(datos) {
                //var positivos = datos["label_1"];
                var cantidad_1  = datos["positivos"];

                //var negativos = datos["label_2"];
                var cantidad_2  = datos["negativos"];

                //var neutros = datos["label_3"];
                var cantidad_3  = datos["neutros"];
                //console.log(positivos + negativos + neutros);
     

    var data = [{
        label: "Positivos   " + cantidad_1,
        data: cantidad_1
    }, {
        label: "Negativos    " + cantidad_2,
        data: cantidad_2
    },{
        label: "Neutros   "  + cantidad_3,
        data:cantidad_3
